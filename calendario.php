       ...
       <section class="seccion contenedor">
        ...
        <?php $contador = 0; ?>  
           ...
           <div class="dia">
              ...
              <p class="hora"><i class="far fa-clock" aria-hidden="true"></i> <?php echo $evento['fecha_evento'] . " " . $evento['hora_evento']; ?>
            <p>
                ...
                switch ($categoria_evento) {
                    case 'Talleres':
                        echo'<i class="fas fa-code" aria-hidden="true"></i> Talleres';
                        break;
                    case 'Conferencias':
                        echo'<i class="fas fa-comments" aria-hidden="true"></i> Conferencias';
                        break;
                    case 'Seminario':
                        echo'<i class="fas fa-university" aria-hidden="true"></i> Seminarios';
                        break;
